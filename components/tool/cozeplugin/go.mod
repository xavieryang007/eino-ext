module code.byted.org/flow/eino-ext/components/tool/cozeplugin
...
require (
	code.byted.org/flow/eino v0.1.4-0.20241021141114-b53807412705
...
require (
	...
	code.byted.org/gopkg/env v1.6.0 // indirect
	...
	code.byted.org/obric/overpass v0.0.0-20240910083547-dccb0343495c // indirect
