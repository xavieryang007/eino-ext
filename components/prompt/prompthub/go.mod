module code.byted.org/flow/eino-ext/components/prompt/prompthub
...
require (
	...
	code.byted.org/flowdevops/fornax_sdk v1.1.1
...
require (
	...
	code.byted.org/flow/eino-ext/components/model/llmgateway v0.0.0-20241122024000-4eed1743fdb6 // indirect
	...
	code.byted.org/obric/flow_telemetry_go v1.0.5 // indirect
	code.byted.org/overpass/data_aml_llmflow_engine v0.0.0-20241107145550-f2da45272e96 // indirect
	code.byted.org/overpass/stone_llm_gateway v0.0.0-20241104094232-76e9a1de03da // indirect
