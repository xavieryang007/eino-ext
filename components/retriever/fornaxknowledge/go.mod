...
require (
	...
	code.byted.org/flow/eino/components/retriever/fornaxknowledge v0.0.0-20240920095124-7f4514c9cb97
...
require (
	...
	code.byted.org/lagrange/viking_go_client v0.0.41 // indirect
