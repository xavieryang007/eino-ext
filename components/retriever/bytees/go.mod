module code.byted.org/flow/eino-ext/components/retriever/bytees
...
require (
	code.byted.org/bytedtrace/interface-go v1.0.16 // indirect
	...
	code.byted.org/gopkg/rand v0.0.0-20200309091730-99d50141bdf7 // indirect
