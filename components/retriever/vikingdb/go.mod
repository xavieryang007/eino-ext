module code.byted.org/flow/eino-ext/components/retriever/vikingdb
...
require (
	...
	code.byted.org/gopkg/thrift v1.4.15 // indirect
	...
	github.com/cloudwego/kitex v0.11.2 // indirect
