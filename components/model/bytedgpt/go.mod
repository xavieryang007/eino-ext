module code.byted.org/flow/eino-ext/components/model/bytedgpt

go 1.18

require (
	code.byted.org/flow/eino v0.3.0
	code.byted.org/flow/eino-ext/components/model/protocols/openai v0.0.0-20241209113439-fb71aacb3a28
